...
function paintDOMwithData(data, id) {
    console.log("data", data);
    const tagToUpdate = document.getElementById(id);
    console.log(id, tagToUpdate);
...
paintDOMwithData(data, "past");
paintDOMwithData(data, "upcoming");
paintDOMwithData(data, "home");
